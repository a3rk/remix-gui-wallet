...
public:
    enum Direction {
        Direction_In  =  RemixCoin::TransactionInfo::Direction_In,
        Direction_Out =  RemixCoin::TransactionInfo::Direction_Out,
...
private:
    explicit TransactionInfo(RemixCoin::TransactionInfo * pimpl, QObject *parent = 0);
private:
    friend class TransactionHistory;
    RemixCoin::TransactionInfo * m_pimpl;
