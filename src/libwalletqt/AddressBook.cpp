...
AddressBook::AddressBook(RemixCoin::AddressBook *abImpl,QObject *parent)
...
QList<RemixCoin::AddressBookRow*> AddressBook::getAll(bool update) const
{
    qDebug(__FUNCTION__);
...
RemixCoin::AddressBookRow * AddressBook::getRow(int index) const
{
